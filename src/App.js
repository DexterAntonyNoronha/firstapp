  ...
  return (
    <div className="App">
      <div class="card mb-4">
        ...
        {/** A JSX with Comments */}
        <span>
          {/* This is a sample comment */} This div have a comment in place. The
          comments are hidden
        </span>
      </div>

      <div className="card">
        <div className="card-header text-light"><span className={redBackground}>I am having a red background color </span></div>
        <div class="card-header text-light"><span className={blueBackground}>I am having a blue background color </span></div>
      </div>
